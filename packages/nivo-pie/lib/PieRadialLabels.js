    ...
    PieRadialLabels.prototype.render = function render() {
        ...
        return _react2.default.createElement(
            ...
            data.filter(function (d) {
                ...
                var angle = (0, _core.midAngle)(d) - Math.PI / 2;
                var positionA = (0, _core.positionFromAngle)(angle, radius + linkOffset);
                var positionB = (0, _core.positionFromAngle)(angle, radius + linkOffset + linkDiagonalLength);
...
PieRadialLabels.propTypes = {
    ...
    theme: _propTypes2.default.shape({
        axis: _propTypes2.default.shape({
            ...
            fontSize: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]).isRequired
        }).isRequired
    }).isRequired
};
